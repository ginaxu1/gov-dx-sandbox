public final table<DriverLicense> key(id) licenseData = table [
...
public final table<VehicleInfo> key(id) vehicleData = table [
...
public final table<VehicleClass> key(id) vehicleClassData = table [
