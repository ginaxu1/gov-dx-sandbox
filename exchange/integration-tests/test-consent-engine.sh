...
test_api_call "Invalid Status" "PUT" "$CONSENT_ENGINE_URL/consents/$NEW_CONSENT_ID" "$INVALID_STATUS_DATA" "400"
...
test_api_call "Revoke Non-existent Consent" "DELETE" "$CONSENT_ENGINE_URL/consents/non_existent_id" "$REVOKE_DATA" "404"
