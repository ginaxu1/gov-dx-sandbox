...
<<<<<<< HEAD
		...
		assert.Len(t, response.ProviderFieldMap, 3, "Should extract 3 fields")
		assert.Len(t, response.Arguments, 1, "Should extract 1 argument")
=======
		queryDoc := parseTestQuery(t, query)
=======
		queryDoc := ParseTestQuery(t, query)
>>>>>>> d12cf8a (address PR comments)
		assert.NotNil(t, queryDoc, "Should parse query successfully")
...
<<<<<<< HEAD
		finalResponse := federator.AccumulateResponse(queryDoc, federatedResponse)
		assert.NotNil(t, finalResponse.Data, "Should have response data")
		assert.Contains(t, finalResponse.Data, "personInfo", "Should contain personInfo")

		// Step 7: Verify final response structure
		personInfo := finalResponse.Data["personInfo"].(map[string]interface{})
=======
...
<<<<<<< HEAD
		...
		response, err := federator.ProviderSchemaCollector(schema, queryDoc)
		assert.NoError(t, err, "Should extract source info directives")
		assert.Len(t, response.ProviderFieldMap, 5, "Should extract 5 fields (including array fields)")
		assert.Len(t, response.Arguments, 1, "Should extract 1 argument")
...
<<<<<<< HEAD
		finalResponse := federator.AccumulateResponse(queryDoc, federatedResponse)
		assert.NotNil(t, finalResponse.Data, "Should have response data")
		assert.Contains(t, finalResponse.Data, "personInfos", "Should contain personInfos")

		// Step 7: Verify final response structure with bulk array
		personInfos := finalResponse.Data["personInfos"].([]interface{})
=======
		response := federator.AccumulateResponse(queryDoc, federatedResponse)
		assert.NotNil(t, response.Data, "Should have response data")
...
<<<<<<< HEAD
		...
		response, err := federator.ProviderSchemaCollector(schema, queryDoc)
		assert.NoError(t, err, "Should extract source info directives")
		assert.Len(t, response.ProviderFieldMap, 6, "Should extract 6 fields")
...
<<<<<<< HEAD
		...
		assert.Contains(t, finalResponse.Data, "personInfo")
		personInfo := finalResponse.Data["personInfo"].(map[string]interface{})
=======
		response := federator.AccumulateResponse(queryDoc, federatedResponse)
		assert.NotNil(t, response.Data, "Should have response data")
...
<<<<<<< HEAD
		assert.Contains(t, finalResponse.Data, "vehicles")
		vehicles := finalResponse.Data["vehicles"].([]interface{})
=======
