...
# Script to prepare the consent-engine service for Choreo deployment
# This copies the shared packages into the service directory

set -e

echo "Preparing consent-engine for Choreo deployment..."
...
echo "✅ Consent Engine prepared for Choreo deployment"
