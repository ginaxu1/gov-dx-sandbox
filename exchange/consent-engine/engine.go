...
// Re-export models constants and types for backward compatibility
// These will be removed in a later PR after all code is migrated
const (
	ErrConsentNotFound     = models.ErrConsentNotFound
	ErrConsentCreateFailed = models.ErrConsentCreateFailed
	ErrConsentUpdateFailed = models.ErrConsentUpdateFailed
	ErrConsentRevokeFailed = models.ErrConsentRevokeFailed
	ErrConsentGetFailed    = models.ErrConsentGetFailed
	ErrConsentExpiryFailed = models.ErrConsentExpiryFailed
	ErrPortalRequestFailed = models.ErrPortalRequestFailed
)

const (
	OpCreateConsent         = models.OpCreateConsent
	OpUpdateConsent         = models.OpUpdateConsent
	OpRevokeConsent         = models.OpRevokeConsent
	OpGetConsentStatus      = models.OpGetConsentStatus
	OpGetConsentsByOwner    = models.OpGetConsentsByOwner
	OpGetConsentsByConsumer = models.OpGetConsentsByConsumer
	OpCheckConsentExpiry    = models.OpCheckConsentExpiry
	OpProcessPortalRequest  = models.OpProcessPortalRequest
)
...
type (
	...
	ConsentPortalView    = models.ConsentPortalView
	ConsentRequest       = models.ConsentRequest
	ConsentRequirement   = models.ConsentRequirement
	ConsentField         = models.ConsentField
	ConsentResponse      = models.ConsentResponse
	UpdateConsentRequest = models.UpdateConsentRequest
	ConsentPortalRequest = models.ConsentPortalRequest
...
const (
	...
	StatusRejected = models.StatusRejected
